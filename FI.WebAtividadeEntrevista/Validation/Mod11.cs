...
namespace WebAtividadeEntrevista.Validation
{
    public class Mod11
    {
        ...
        private bool IsNotInvalidSequence(string value)
        {
            var allCharsAreEqual = value.Distinct().Count() == 1;
            return allCharsAreEqual;
        }

        private static bool IsInvalidMod11(int[] multipliersForFirstDigit,
                                            int[] multipliersForSecondDigit,
                                            string value)
        {
        ...
        private static int GetSecondDigit(int[] multipliers,
                                            string value,
                                            int firstDigit)
        {
